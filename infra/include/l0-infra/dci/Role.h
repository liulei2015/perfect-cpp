...
#define SERVICE(service) get##service()
#define USE_SERVICE(service) virtual ROLE_PROTO_TYPE(service) = 0
#define HAS_SERVICE(service) USE_SERVICE(service)
...
//#define GENERIC_ROLE(role) struct role : ::details::Role
