#ifndef INCL_USI_BASE_TRANS_DATA_H
#define INCL_USI_BASE_TRANS_DATA_H
...
public:
   ...
   Status modify()
   {
        USI_ASSERT_TRUE(ACTIVE == state);

        USI_ASSERT_SUCC_CALL(getCurrentValue().copyTo(getAnotherValue()));
...
#define __trans_data(p_type, p_name) USI_NS::TransData< p_type > p_name
