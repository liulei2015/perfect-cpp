#ifndef __USI_BASE_UNKNOWN_H__
#define __USI_BASE_UNKNOWN_H__
...
#define __IMPL_CONTEXT_ROLE(role)                           \
    USI_PEEK_VALID_PTR(role);                               \
    return *role;

#define IMPL_OBJ_CONTEXT_ROLE(object, role)                     \
    DECL_OBJECT_ROLE(object, role)                          \
{                                                           \
    __IMPL_CONTEXT_ROLE(dci::unknown_cast<role>(context))   \
}

#define IMPL_CONTEXT_ROLE(role)                     \
    DECL_ROLE(role)                          \
{                                                           \
    __IMPL_CONTEXT_ROLE(dci::unknown_cast<role>(context))   \
}

#define __IMPL_CONTEXT_ROLE_PTR(role)                       \
    USI_PEEK_VALID_PTR(role);                               \
    return role;
